/**
 * Registos, utilizadores, produtos, squads, operação e agenda.
 * Módulos extraídos: configMedia, metas, audit, baseClientes, gts — ver ./README.md
 */
import {
  collection,
  getDocs,
...
export interface RegistroRow {
  ...
  /** Legado: registo criado por integração externa (ex. crm_native) */
